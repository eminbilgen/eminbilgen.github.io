...
function Projects() {
  return (
    <div className='mekan w-full min-h-[200vh] bigph:min-h-[150vh] tallph:min-h-[165vh] smph:min-h-[200vh] laptop:min-h-screen tablet:min-h-screen flex flex-grow justify-center items-center flex flex-col'>
      ...
      <div className=' bg-gri-100 dark:bg-[#292929] w-11/12 laptop:w-8/12 h-max tablet:h-4/6 laptop:h-4/6 rounded-laptop flex items-center justify-center mb-4  hover:bg-gri-300 dark:hover:bg-[#242424]'>
