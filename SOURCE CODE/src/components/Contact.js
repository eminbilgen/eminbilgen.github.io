...
function Contact() {
  ...
  return (
    <div className='mekan w-full h-screen flex justify-center items-center flex flex-col hover:cursor-default'>
      <h1 className='about-baslik text-4xl font-bold text-underline mb-10 underline underline-offset-1 hover:translate-y-2 hover:scale-95 dark:text-white'>Contact me:</h1>
      <div className='bg-gri-100 dark:bg-[#292929]  w-10/12 h-2/4 rounded-md flex items-center justify-center hover:bg-gri-300 dark:hover:bg-[#242424]'>
        ...
        <form ref={form} onSubmit={handleSubmit} className='h-full w-full flex flex-col justify-around items-center'>
          <label className="block flex flex-col items-start">
            <span className="block text-sm font-medium text-slate-700 dark:text-[#f2f2f2]">Email Address:</span>
          ...
          <label className="block flex flex-col items-start">
            <span className="block text-sm font-medium text-slate-700 dark:text-[#f2f2f2]">Name:</span>
          ...
          <label className="block flex flex-col items-start">
            <span className="block text-sm font-medium text-slate-700 dark:text-[#f2f2f2]">Message:</span>
          ...
          <input type='submit' value="Send" className='bg-gri-300 hover:bg-gri-200 dark:bg-[#090909] dark:hover:bg-[#151515] border-2 dark:border-white border-black dark:text-white text-black font-bold rounded w-[11.5rem] h-12 flex justify-center items-center' />
        </form>
        </div>
      </div>
    </div>
